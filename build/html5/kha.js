...
Main.__name__ = true;
Main.main = function() {
	kha_System.init("Unknown",600,600,function() {
		new Unknown();
	});
};
Math.__name__ = true;
...
var Unknown = function() {
	var _g = this;
	this.backbuffer = kha_Image.createRenderTarget(600,600);
	kha_Assets.loadEverything(function() {
		kha_System.notifyOnRender($bind(_g,_g.render));
		kha_Scheduler.addTimeTask($bind(_g,_g.update),0,0.0166666666666666664);
	});
};
$hxClasses["Unknown"] = Unknown;
...
Unknown.prototype = {
	...
	,render: function(frame) {
		...
		g.begin(null,-10637854);
		g.set_color(kha__$Color_Color_$Impl_$.White);
		g.set_font(kha_Assets.fonts.LiberationSans_Regular);
		g.set_fontSize(60);
		...
		g.end();
		frame.get_g2().begin();
		kha_Scaler.scale(this.backbuffer,frame,kha_System.get_screenRotation());
		frame.get_g2().end();
	}
	,__class__: Unknown
};
...
var kha_FontList = function() {
	this.LiberationSans_RegularDescription = { files : ["LiberationSans-Regular.ttf"], type : "font", name : "LiberationSans_Regular"};
	this.LiberationSans_RegularName = "LiberationSans_Regular";
	this.LiberationSans_Regular = null;
};
$hxClasses["kha.FontList"] = kha_FontList;
kha_FontList.__name__ = true;
kha_FontList.prototype = {
	LiberationSans_Regular: null
	,LiberationSans_RegularName: null
	,LiberationSans_RegularDescription: null
	,LiberationSans_RegularLoad: function(done) {
		kha_Assets.loadFont("LiberationSans_Regular",function(font) {
			done();
		});
	}
	,LiberationSans_RegularUnload: function() {
		this.LiberationSans_Regular.unload();
		this.LiberationSans_Regular = null;
	}
